...
- 📋 **Onglet presse-papiers** — historique capturé en arrière-plan, cherchable sur le texte et les notes, avec des mémos écrits à la main dans la même liste, épinglage, envoi vers la traduction et effacement à deux niveaux. Vides, chaînes de type OTP et blocs de clé PEM ne sont jamais stockés
...
3. L’application v0.3.2 utilise uniquement une signature **ad hoc**, sans Developer ID ni notarisation ; les avertissements Gatekeeper sont attendus.
...
2. Windows SmartScreen peut avertir car v0.3.2 n'est pas signé ; c'est normal. Aucun Authenticode.
...
- L’application macOS v0.3.2 est signée ad hoc, sans Developer ID ni notarisation ; les installateurs Windows ne sont pas signés avec Authenticode. Les avertissements Gatekeeper et SmartScreen sont attendus.
