...
3. Die v0.2.29-App ist nur **ad hoc** signiert, ohne Developer ID oder Notarisierung; Gatekeeper-Warnungen sind zu erwarten.
...
2. Windows SmartScreen kann warnen, da v0.2.29 unsigniert ist; das ist erwartbar. Kein Authenticode.
...
- Die macOS-App v0.2.29 ist ad hoc signiert, ohne Developer ID oder Notarisierung; die Windows-Installer haben keine Authenticode-Signatur. Gatekeeper- und SmartScreen-Warnungen sind zu erwarten.
