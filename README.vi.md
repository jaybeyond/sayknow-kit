...
- 📊 **Trạng thái hệ thống** — CPU, bộ nhớ và ổ đĩa hệ thống; nhiệt độ gói CPU hiển thị “không khả dụng” trong v0.2.8 vì chưa có bộ chuyển đổi nhiệt độ được xác minh, cũng như trên hệ thống không hỗ trợ.
...
3. Ứng dụng v0.2.8 chỉ có chữ ký **ad hoc**, không có Developer ID hay notarization; cảnh báo Gatekeeper là điều bình thường.
...
2. Windows SmartScreen có thể cảnh báo vì v0.2.8 chưa được ký; điều này bình thường. Không có Authenticode.
...
- Ứng dụng macOS v0.2.8 dùng chữ ký ad hoc, không có Developer ID hay notarization; trình cài Windows không có chữ ký Authenticode. Cảnh báo Gatekeeper và SmartScreen là điều bình thường.
