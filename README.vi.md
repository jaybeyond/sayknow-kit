...
3. Ứng dụng v0.3.1 chỉ có chữ ký **ad hoc**, không có Developer ID hay notarization; cảnh báo Gatekeeper là điều bình thường.
...
2. Windows SmartScreen có thể cảnh báo vì v0.3.1 chưa được ký; điều này bình thường. Không có Authenticode.
...
- Ứng dụng macOS v0.3.1 dùng chữ ký ad hoc, không có Developer ID hay notarization; trình cài Windows không có chữ ký Authenticode. Cảnh báo Gatekeeper và SmartScreen là điều bình thường.
